...
# 3. Setelah import databases login ke phpmyadmin maka 
bisa masuk ke http://localhost/login/
# 4. untuk masuk bisa dafar menjadi member menggunakan fitur create account.
